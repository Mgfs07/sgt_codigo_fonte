...
export class AppComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    ngOnInit() {
        ...
        this.menuService.itens = [
            { label: 'Painel', icon: 'home', routerLink: ['/'] },
            { label: 'Projetos', icon: 'book', routerLink: ['/projetos'] },
            { label: 'Clientes', icon: 'worker', routerLink: ['/clientes']},
            { label: 'Usuários', icon: 'supervisor_account', routerLink: ['/usuarios'] },
        ];
    }
