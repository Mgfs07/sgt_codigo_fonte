...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r402.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r404); var ctx_r403 = ɵngcc0.ɵɵnextContext(); return ctx_r403.menu.itemClick($event, ctx_r403.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r400.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r400.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r400.item.disabled ? null : "0")("data-automationid", ctx_r400.item.automationId)("target", ctx_r400.item.target)("title", ctx_r400.item.title)("id", ctx_r400.item.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r400.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r400.item.label);
} }
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 5);
} if (rf & 2) {
    var ctx_r405 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r405.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r407); var ctx_r406 = ɵngcc0.ɵɵnextContext(); return ctx_r406.menu.itemClick($event, ctx_r406.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r401.item.routerLink)("queryParams", ctx_r401.item.queryParams)("routerLinkActive", "ui-menuitem-link-active")("routerLinkActiveOptions", ctx_r401.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(18, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(19, _c1, ctx_r401.item.disabled))("fragment", ctx_r401.item.fragment)("queryParamsHandling", ctx_r401.item.queryParamsHandling)("preserveFragment", ctx_r401.item.preserveFragment)("skipLocationChange", ctx_r401.item.skipLocationChange)("replaceUrl", ctx_r401.item.replaceUrl)("state", ctx_r401.item.state);
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r401.item.automationId)("target", ctx_r401.item.target)("id", ctx_r401.item.id)("tabindex", ctx_r401.item.disabled ? null : "0")("title", ctx_r401.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r401.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r401.item.label);
} }
var _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r413 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r413.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r413 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r413.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r413.automationId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(submenu_r413.label);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r419 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r413 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r419.visible === false || submenu_r413.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r419 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r413 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r419.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r419)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r419.visible === false || submenu_r413.visible === false))("ngStyle", item_r419.style);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r419 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", item_r419.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r419.separator);
} }
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r413 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", submenu_r413.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r413.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", submenu_r413.items);
} }
function Menu_div_0_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r410.model);
} }
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r427 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r427.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 10);
} if (rf & 2) {
    var item_r427 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r427.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r427)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r427.visible === false))("ngStyle", item_r427.style);
} }
function Menu_div_0_4_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r427 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", item_r427.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r427.separator);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r433); var ctx_r432 = ɵngcc0.ɵɵnextContext(); return ctx_r432.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r433); var ctx_r434 = ɵngcc0.ɵɵnextContext(); return ctx_r434.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵclassMap(ctx_r408.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r408.popup))("ngStyle", ctx_r408.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r408.showTransitionOptions, ctx_r408.hideTransitionOptions)))("@.disabled", ctx_r408.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r408.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r408.hasSubMenu());
} }
